...
$_db = $this->__construct();	
				...
				$_sql_trancate ='TRUNCATE TABLE HJK.SUB_HJK'; 
...
$q = 'INSERT INTO HJK.SUB_HJK(`address_id`, `kvartplata`, `otoplenie`,`podogrev`,`voda`,`energy`, `tbo`, `stoki`,`kv`, `ot`,`gv`,`xv`,`en`,`tb`,`st`,`summa` )  values (';
