...
$_db = $this->__construct();	
				...
				$_sql_trancate ='TRUNCATE TABLE OSBB.LG_OSBB'; 
...
$q = 'INSERT INTO  OSBB.LG_OSBB(`cdpr`,`idcode`,`fio`,`ppos`,`rs`,`yearin`,`monthin`,`lgcode`,`data1`,`data2`,`lgkol`,`lgkat`,`lgprc`,`fact`,`tarif`,`flag`,`summ` )  values (';
