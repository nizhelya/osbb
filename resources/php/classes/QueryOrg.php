...
// GET RESULT
...

	{
			...
			break;
			case "addFilialDvodomer"://in use			
			        $this->sql='UPDATE YISGRAND.TM_ORG_FILIAL SET YISGRAND.TM_ORG_FILIAL.dvodomer_id='.$this->dteplomer_id.',YISGRAND.TM_ORG_FILIAL.dvodomer=1  WHERE YISGRAND.TM_ORG_FILIAL.filial_id='.$this->filial_id.' LIMIT 1';
...
public function Org(stdClass $params)
	{
		...
		switch ($this->what) {
			...
			$this->sql='CALL YISGRAND.add_org('.$this->cat_id.',"'.$this->boss.'","'.$this->gbuh.'","'.$this->sname.'","'.$this->fname.'","'.$this->uaddress.'",'
						...
						.'"'.$this->inn.'","'.$this->kod_ytke.'","'.$this->kod_vik.'",@org_id,@success,@msg)';
						//print($this->sql);
			break;
			...
			$this->sql='CALL YISGRAND.update_org('.$this->org_id.','.$this->cat_id.',"'.$this->boss.'","'.$this->gbuh.'","'.$this->sname.'","'.$this->fname.'","'.$this->uaddress.'",'
						...
						.'"'.$this->buhgalter.'","'.$this->inn.'","'.$this->kod_ytke.'","'.$this->kod_vik.'",@success,@msg)';
						//print($this->sql);
			break;
			case "deleteOrg":
