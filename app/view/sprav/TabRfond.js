/*
 * File: app/view/sprav/TabRfond.js
 *
...
Ext.define('Osbb.view.sprav.TabRfond', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.tabrfond',

    requires: [
        'Osbb.view.sprav.TabRfondViewModel',
        'Osbb.view.sprav.TabRfondViewController',
        'Ext.form.Panel',
        'Ext.grid.Panel',
        'Ext.view.Table',
        'Ext.toolbar.Toolbar',
                                ...
                                items: [
                                    {
                                        ...
                                        items: [
                                            ...
                                            },
                                            {
                                                ...
                                                text: 'Перерасчитать РФонд  за период'
                                            },
                                            {
                                                xtype: 'datefield',
                                                x: 10,
                                            ...
                                            },
                                            {
                                                ...
                                                width: 490,
                                                icon: 'resources/css/images/ico/add.png',
                                                text: 'начислить РФонд  за период'
                                            },
                                            {
                                                xtype: 'button',
                                                x: 15,
                                                ...
                                                formBind: false,
                                                disabled: true,
                                                id: 'btAddNachRfondPrev',
                                                width: 360,
                                                icon: 'resources/css/images/ico/add.png',
                                                text: 'начислить Рфонд  за предыдущий период'
                                            },
                                            {
                                                xtype: 'button',
                                                handler: function(button, event) {
                                                ...
                                                y: 15,
                                                disabled: true,
                                                id: 'btnClearNachRfond',
                                                icon: 'resources/css/images/ico/no.png',
                                                iconAlign: 'bottom',
                                                text: '',
                                                tooltip: 'Сброс признака <br>Рфонд  начислен'
                                            }
                                        ]
                                    }
                                ]
