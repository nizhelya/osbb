/*
 * File: app/view/sprav/WinAddEnergomer.js
 *
...
Ext.define('Osbb.view.sprav.WinAddEnergomer', {
    extend: 'Ext.window.Window',
    alias: 'widget.winaddenergomer',

    requires: [
        'Osbb.view.sprav.WinAddEnergoViewModel',
        'Osbb.view.sprav.WinAddEnergomerViewController',
        'Ext.form.Panel',
    ...
    controller: 'winaddenergomer',
    viewModel: {
        type: 'winaddenergomer'
    },
    height: 488,
    id: 'winAddEnergomer',
    width: 568,
    ...
    items: [
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    uncheckedValue: '0',
                    listeners: {
                        change: 'onChkExistentEnergomerChange'
                    }
                },
                {
                    xtype: 'combobox',
                    ...
                    listeners: {
                        select: 'onCbExistentEnergomerSelect'
                    }
                },
                {
                    xtype: 'button',
