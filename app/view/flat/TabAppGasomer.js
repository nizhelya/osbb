/*
 * File: app/view/flat/TabAppGasomer.js
 *
...
Ext.define('Osbb.view.flat.TabAppGasomer', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.flattabappgasomer',

    requires: [
        'Osbb.view.flat.TabAppGasomerViewModel',
        'Ext.form.Panel',
        'Ext.grid.Panel',
        'Ext.view.Table',
    ...
    viewModel: {
        type: 'flattabappgasomer'
    },
    id: 'tabAppGasomer',
    layout: 'fit',
    title: 'Газовый счетчик ',
                        ...
                        items: [
                            {
                                ...
                                items: [
                                    ...
                                    },
                                    {
                                        ...
                                        collapsed: true,
                                        collapsible: true,
                                        title: 'Приборы учета снятые с учета',
                                                        ...
                                                        handler: function(view, rowIndex, colIndex, item, e, record, row) {
                                                            ...
                                                            Ext.MessageBox.confirm({
                                                                ...
                                                                fn:function(btn,newValue){
                                                                    if(btn=='ok'){
                                                                        QueryGasomer.spisanGasomer(value,function(results){
                                                ...
                                                items: [
                                                    {
                                                        ...
                                                        handler: function(view, rowIndex, colIndex, item, e, record, row) {
                                                            ...
                                                            Ext.MessageBox.confirm({
                                                                ...
                                                                fn:function(btn,newValue){
                                                                    if(btn=='ok'){
                                                                        QueryGasomer.delGasomer(value,function(results){
                                                                            if (results.success==="1"){
                                                        ...
                                                        handler: function(view, rowIndex, colIndex, item, e, record, row) {
                                                            Ext.MessageBox.confirm({
                                                                ...
                                                                fn:function(btn,newValue){
                                                                    if(btn=='ok'){
                                                                        var dt = new Date();
                                                                        var fmAppPribor = Ext.getCmp('fmGasomer');
                                                                        var tek = fmAppPribor.getForm().findField('tek').getValue();

                                                                        var winAddPribor = Ext.ClassManager.instantiateByAlias('widget.winaddgasomer');
                                                                        var form = winAddPribor.down('#fmAddGasomer');
                                                                        var stUser = Ext.data.StoreManager.get("StUser");
                                                                        var values =stUser.getAt(0);
                                                                        ...
                                                                        values.set({'vibor':'changeAppGasomer','rowind':rowIndex});
                                                                        stUser.sync();
                                                                        form.getForm().findField('tek').setFieldLabel('Текущие показания');
                                                                        //form.getForm().findField('new_address_id').hide();
                                                                        form.down('#btAddGasomer').setText('Перебросить счетчик');

                                                                        form.down('#fcntNewGasomer').hide();
                                                                        form.down('#chkExistentGasomer').hide();
                                                            ...
                                                            Ext.MessageBox.confirm({
                                                                ...
                                                                fn:function(btn,newValue){
                                                                    if(btn=='ok'){
                                                                        ...
                                                                        view.getSelectionModel().select(rowIndex);
                                                                        values.set({'vibor':'editAppGasomer','rowind':rowIndex});
                                                                        stUser.sync();
                                                                        form.getForm().findField('tek').setFieldLabel('Текущие показания');

                                                                        form.down('#btAddGasomer').setText('Обновить данные');
                                                                        form.down('#chkExistentGasomer').hide();
                                                ...
                                                items: [
                                                    {
                                                        handler: function(view, rowIndex, colIndex, item, e, record, row) {
                                                            ...
                                                            Ext.MessageBox.confirm({
                                                                ...
                                                                fn:function(btn,newValue){
                                                                    if(btn=='ok'){
                                                                        QueryGasomer.outGasomerHistory(value,function(results){
                                                                            if (results.success==="1"){
                                                                                stPribor.load({
                                                                                    params: {
                                                                                        what:'AppGasomer',
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        handler: function(view, rowIndex, colIndex, item, e, record, row) {
                                                            ...
                                                            Ext.MessageBox.confirm({
                                                                ...
                                                                fn:function(btn,newValue){
                                                                    if(btn=='ok'){
                                                                        QueryGasomer.inGasomerHistory(value,function(results){
                                                                            if (results.success==="1"){
                                                                                stPribor.load({
                                                                                    params: {
                                                                                        what:'AppGasomer',
                                                ...
                                                items: [
                                                    {
                                                        ...
                                                        handler: function(view, rowIndex, colIndex, item, e, record, row) {
                                                            ...
                                                            var stUser = Ext.data.StoreManager.get("StUser");
                                                            var stHPribor = Ext.data.StoreManager.get("StHGasomer");
