...
Ext.define('Osbb.controller.Kassa', {
    ...
    onTabKassaActivate: function(component, eOpts) {
        ...
        var stTekNachKassa1 = Ext.data.StoreManager.get("StTekNachKassa1");//QueryKassa.getResults
        var stTekNachKassa2 = Ext.data.StoreManager.get("StTekNachKassaOrg");//QueryKassa.getResults
            ...
            callback: function(records,operation,success){
                ...
                if(success){
                    ...
                    if (records.length) {
                        ...
                        stTekNachKassa.load({
                            ...
                            callback: function(records,operation,success){
                                ...
                                if (success)  {
                                    ...
                                    fmTekNachKassa.getForm().findField('cbDo9').setDisabled(false);
                                    ...
                                    fmTekNachKassa.getForm().findField('cbNext9').setDisabled(false);
                        ...
                        //stTekNachKassa1.removeAll();
                        stTekNachKassa1.load({
                            params: {
                                login:login,
                                password:password,
                                what_id:address_id,
    ...
    onDelTekPokVodKassaClick: function(button, e, eOpts) {
        ...
        var stTekNachKassa1 = Ext.data.StoreManager.get("StTekNachKassa1");
                    ...
                    QueryVodomer.delPokVodomera(value,function(results){
                        if (results.success === "1"){
                            ...
                            stTekNachKassa1.load({
                                ...
                                callback: function(rec1,operation,succ){
                                    if(succ){
                                        fmTekNachKassa1.getForm().loadRecord(rec1[0]);
                                    }
                                },
                                scope:this
                            });
    ...
    resetFmKassa: function() {
        ...
        form.getForm().findField('cbNext9').setDisabled(false).setValue(false);
        ...
        form.getForm().findField('cbDo9').setDisabled(false).setValue(false);
